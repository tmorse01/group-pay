    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-neutral-600 dark-mode:text-neutral-400 mt-1">
            {groups?.length
        ...
        {filteredGroups && filteredGroups.length > 0 ? (
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {filteredGroups.map((group) => (
              <div
                key={group.id}
                className="bg-white dark-mode:bg-neutral-800 rounded-lg border border-neutral-200 dark-mode:border-neutral-700 p-6 hover:shadow-md transition-all duration-200 hover:border-neutral-300 dark-mode:hover:border-neutral-600"
              >
                <div className="space-y-4">
                  {/* Header */}
                  <div className="flex justify-between items-start">
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-semibold text-neutral-900 dark-mode:text-neutral-50 truncate">
                        {group.name}
                      </h3>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 bg-neutral-50 dark-mode:bg-neutral-700 rounded-lg">
                      <div className="text-lg font-semibold text-neutral-900 dark-mode:text-neutral-50">
                        {group.memberCount}
                      </div>
                      <div className="text-xs text-neutral-600 dark-mode:text-neutral-400">
